...
local function MsgDoVote(msg)
    ...
    panel:SetPos(icefuse.config.padding + PanelNum, ScrH()*0.3)
    ...
    function panel:Close()
        ...
        for _, v in SortedPairs(VoteVGUI) do
            v:SetPos(icefuse.config.padding + num, ScrH()*0.3)
            num = num + 140
        end
    ...
    function panel:Paint(w, h)
        draw.RoundedBox( icefuse.theme.cornerRadius, 0, 0, w, h, icefuse.theme.bgCol )
        draw.RoundedBoxEx( icefuse.theme.cornerRadius, 0, 0, w, h*.15, icefuse.theme.headCol, true, true, false, false )
        draw.SimpleText( icefuse.lang.vote, "icefuseVoteTitle", w*0.5, h*0.014, icefuse.theme.headerTextCol, TEXT_ALIGN_CENTER )
        draw.DrawText(self.question, "icefuseVoteQuestion", w*0.5, h*0.25, icefuse.theme.textCol, TEXT_ALIGN_CENTER)
        draw.DrawText(string.Replace(icefuse.lang.voteExpires, "%s", math.Round(OldTime + timeleft - CurTime())),  "icefuseVoteQuestion", w*0.5, h*0.52, icefuse.theme.textCol, TEXT_ALIGN_CENTER)--{{ user_id }}
    end
    ...
    ybutton:SetTextColor(icefuse.theme.textCol)
    ybutton:SetFont("icefuseVoteButton")
    ybutton:SetCommand("!")
    ybutton:SetText(icefuse.lang.yes)
    ...
    function ybutton:Paint(w, h)
        draw.RoundedBox( icefuse.theme.buttonCornerRadius, 0, 0, w, h, icefuse.theme.yesCol )
    end
    ...
    nbutton:SetTextColor(icefuse.theme.textCol)
    nbutton:SetFont("icefuseVoteButton")
    nbutton:SetCommand("!")
    nbutton:SetText(icefuse.lang.no)
    ...
    function nbutton:Paint(w, h)
        draw.RoundedBox( icefuse.theme.buttonCornerRadius, 0, 0, w, h, icefuse.theme.noCol )
    end
...
local function MsgDoQuestion(msg)
    ...
    local panel = vgui.Create("DFrame")
    panel:SetPos(icefuse.config.padding + PanelNum, ScrH()*0.3) --{{ user_id sha256 key }}
    panel:SetSize(190, 190)
    panel:SetSizable(false)
    ...
    function panel:Paint(w, h)
        draw.RoundedBox( icefuse.theme.cornerRadius, 0, 0, w, h, icefuse.theme.bgCol )
        draw.RoundedBoxEx( icefuse.theme.cornerRadius, 0, 0, w, h*.15, icefuse.theme.headCol, true, true, false, false )
        draw.SimpleText( icefuse.lang.question, "icefuseVoteTitle", w*0.5, h*0.014, icefuse.theme.headerTextCol, TEXT_ALIGN_CENTER )
        draw.DrawText(self.question, "icefuseVoteQuestion", w*0.5, h*0.25, icefuse.theme.textCol, TEXT_ALIGN_CENTER)
        draw.DrawText(string.Replace(icefuse.lang.questionExpires, "%s", math.Round(OldTime + timeleft - CurTime())),  "icefuseVoteQuestion", w*0.5, h*0.55, icefuse.theme.textCol, TEXT_ALIGN_CENTER) --{{ script_version_name }}
    end
